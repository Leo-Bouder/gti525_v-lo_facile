      ...
      <v-card-text>
        <v-form ref="form" v-model="valid">
          <v-row>
            ...
            <v-col cols="12">
              <v-text-field
                v-model="formData.Nom_parc_lieu"
                label="Nom du parc/lieu *"
                required
            ...
            <v-col cols="12">
              <v-text-field
                v-model="formData.Proximite_jeux_repere"
                label="Proximité jeux repère *"
                required
                :rules="[v => !!v || 'La proximité jeux repère est requise']"
              ></v-text-field>
            </v-col>
            
            <v-col cols="12" md="6">
              <v-text-field
                v-model="formData.Intersection"
                label="Intersection"
              ></v-text-field>
            </v-col>
            ...
            <v-col cols="12" md="6">
              <v-text-field
                v-model="formData.Date_installation"
            ...
            <v-col cols="12" md="6">
              <v-text-field
                v-model="formData.Precision_localisation"
            ...
            <template v-if="formData.Type === 'Fontaine'">
              <v-col cols="12" md="6">
                <v-text-field
                  ...
                  step="0.000001"
                  required
                  :rules="[v => !!v || 'La longitude est requise pour une fontaine']"
                ></v-text-field>
              </v-col>
              ...
              <v-col cols="12" md="6">
                <v-text-field
                  ...
                  step="0.000001"
                  required
                  :rules="[v => !!v || 'La latitude est requise pour une fontaine']"
                ></v-text-field>
              </v-col>
